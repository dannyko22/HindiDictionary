...
public class MyArrayAdapter extends ArrayAdapter<DictionaryData> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewHindiChars = (TextView) rowView.findViewById(R.id.textViewHindiChars);
        ...
        if (itemsArrayList.get(0)._id != -1) {
            ...
            textViewHindiChars.setText(itemsArrayList.get(position).getHindiCharsSpannable(searchKey));
        } else {
            //textViewJapaneseChars.setText("");
            textViewEnglishChars.setText("");
            textViewHindiChars.setText("");
        }
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (itemsArrayList.get(0)._id != -1) {
                    ...
                    i.putExtra("hindiWords", itemsArrayList.get(position).getHindiChars(searchKey));
